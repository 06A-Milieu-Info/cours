---
title: "TP1 — Collaboration et coédition"
description: "Partage OneDrive, gestion de fichiers, coédition Word (révision/commentaires) et compréhension du plagiat."
---

<div class="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
  <div>
    <h1 class="m-0">TP1 — Collaboration et coédition</h1>
    <p class="m-0 text-sm opacity-80">420-06A — Milieu de l’informatique</p>
  </div>
  <div class="text-sm opacity-80">
    <div><strong>Équipe :</strong> 3 à 4 étudiants</div>
    <div><strong>Remise :</strong> dépôt sur Léa (voir consignes)</div>
  </div>
</div>
...
<div class="flex flex-wrap md:flex-nowrap gap-4 items-start">
   <img src="./images/tp1-etude-de-cas.png" alt="etude de cas" class="img-bordered w-auto max-w-full md:max-w-[48%] h-auto object-contain" />
   <img src="./images/tp1-ressources.png" alt="ressources" class="img-bordered w-auto max-w-full md:max-w-[48%] h-auto object-contain" />
</div>
...
<ul class="checklist">
  <li><label><input type="checkbox"><span class="check-text">Il y a un dossier classé complètement en bas du dossier racine et il contient :</span></label>
    <ul class="checklist">
      <li><label><input type="checkbox"><span class="check-text">`Résumé_commun.docx`</span></label></li>
      <li><label><input type="checkbox"><span class="check-text">Le document Word de coédition (copie coéditée)</span></label></li>
    </ul>
  </li>
  <li><label><input type="checkbox"><span class="check-text">Il y a un dossier pour chacun des coéquipiers contenant :</span></label>
    <ul class="checklist">
      <li><label><input type="checkbox"><span class="check-text">`Informations_sur_plagiat.docx`</span></label></li>
      <li><label><input type="checkbox"><span class="check-text">`Résumé_de_lecture.docx`</span></label></li>
    </ul>
  </li>
  <li><label><input type="checkbox"><span class="check-text">Il y a un dossier `Ressources`</span></label></li>
  <li><label><input type="checkbox"><span class="check-text">Il y a un dossier `Études de cas`</span></label>
    <ul class="checklist">
      <li><label><input type="checkbox"><span class="check-text">Il contient un `Modèle de dossier` (en haut)</span></label></li>
      <li><label><input type="checkbox"><span class="check-text">Il contient une étude de cas par coéquipier</span></label></li>
    </ul>
  </li>
  <li><label><input type="checkbox"><span class="check-text">Les fichiers du `.zip` sont dézippés, classés et renommés correctement</span></label></li>
  <li><label><input type="checkbox"><span class="check-text">Le tableau d’identification d'équipe est complété en coédition</span></label></li>
  <li><label><input type="checkbox"><span class="check-text">Le dossier racine TP1 est compressé et déposé dans Léa</span></label></li>
</ul>
