...
<ul class="checklist">
  <li><label><input type="checkbox"><span class="check-text">Créer votre session utilisateur sur l'ordinateur</span></label></li>
  <li><label><input type="checkbox"><span class="check-text">Vérifier et configurer la langue et la disposition du clavier (Français — Canada)</span></label></li>
  <li><label><input type="checkbox"><span class="check-text">Afficher les extensions de fichiers</span></label></li>
  <li><label><input type="checkbox"><span class="check-text">Installer Google Chrome et ajouter vos favoris</span></label></li>
  <li><label><input type="checkbox"><span class="check-text">Installer Teams, OneDrive et Outlook, activer notifications</span></label></li>
...
<img src="./images/utilisateurs.png" alt="utilisateurs" class="img-bordered w-[30%]" />
...
<img src="./images/langue.png" alt="langue" class="img-bordered w-[30%]" />

</div>

<img src="./images/langue2.png" alt="langue 1" class="img-bordered mb-5" />
<img src="./images/langue3.png" alt="langue 2" class="img-bordered mb-5" />
<img src="./images/langue4.png" alt="langue 3" class="img-bordered" />
...
<img src="./images/extensions.png" alt="extensions" class="img-bordered" />
...
- Télécharger [Microsoft 365](https://office.com)
    - <img src="./images/office.png" alt="office" class="img-bordered" />
    - <img src="./images/installer-office.png" alt="installer-office" class="img-bordered" />
...
<img src="./images/onedrive.png" alt="onedrive" class="img-bordered w-[30%]" />
