		...
		nav: [
			...
			},
			{
				...
				items: [
					...
					{ text: "05 — PowerPoint", link: "/modules/05-powerpoint/bonnes-pratiques" },
					{ text: "06 — Éthique (TP4)", link: "/travaux/tp4-ppt-ethique" },
				],
			},
			{
				text: "Travaux",
			...
			},
			{
				...
				items: [
					...
					},
					{
						...
						collapsed: true,
						items: [
							{ text: "Bonnes pratiques", link: "/modules/05-powerpoint/bonnes-pratiques" },
						],
					}
				],
