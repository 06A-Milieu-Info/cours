---
title: Lab 01 — Vocabulaire
---

# Lab 01 — Vocabulaire

## Contexte
Ce court laboratoire permet de vérifier que vous avez configuré correctement votre poste (session, langue, clavier, navigateur, OneDrive, etc.). Le document à remplir contient des questions courtes et des vérifications simples.

## Objectifs
- Vérifier les configurations minimales de votre poste.
- S'exercer à remplir un document Word fourni et à le remettre sur la plateforme **Léa**.

## Prérequis
- Un ordinateur avec Microsoft Word installé.
- Accès à Léa (compte étudiant).

## Document à télécharger
Téléchargez le document Word à partir de :

- <a href="./lab-01-vocabulaire.docx" target="_blank" rel="noopener">Télécharger le document d'exercice (docx)</a>

## Consignes (pas à pas)
1. Téléchargez le fichier Word (lien ci‑dessus) sur votre poste.
